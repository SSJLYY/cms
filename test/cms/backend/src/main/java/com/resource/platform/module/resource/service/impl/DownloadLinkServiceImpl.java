...
public class DownloadLinkServiceImpl implements DownloadLinkService {
    ...
    public DownloadLinkVO createDownloadLink(DownloadLinkDTO dto) {
        ...
        if (dto == null) {
            log.warn("下载链接DTO为空");
            throw new BusinessException(BizErrorCode.PARAM_ERROR, "下载链接数据不能为空");
        }
        ...
        if (dto.getTitle() == null || dto.getTitle().trim().isEmpty()) {
            ...
            throw new BusinessException(BizErrorCode.PARAM_ERROR, "下载链接标题不能为空");
        }
        ...
        if (rows > 0) {
            ...
            throw new BusinessException(BizErrorCode.DOWNLOAD_LINK_SAVE_FAILED);
        }
    ...
    public void deleteDownloadLink(Long id) {
        ...
        if (rows > 0) {
            ...
            throw new BusinessException(BizErrorCode.DOWNLOAD_LINK_DELETE_FAILED);
        }
