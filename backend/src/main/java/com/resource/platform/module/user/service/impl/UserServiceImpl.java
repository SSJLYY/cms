package com.resource.platform.module.user.service.impl;
...
public class UserServiceImpl implements UserService {
    ...
    public UserVO authenticate(String username, String password) {
        ...
        if (user == null) {
            ...
            throw new BusinessException(BizErrorCode.USER_NOT_FOUND);
        }
        ...
        if (user.getStatus() == 0) {
            ...
            throw new BusinessException(BizErrorCode.USER_DISABLED);
        }
        ...
        if (!passwordEncoder.matches(password, user.getPassword())) {
            ...
            throw new BusinessException(BizErrorCode.PASSWORD_ERROR);
        }
