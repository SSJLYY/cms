...
import com.resource.platform.module.promotion.mapper.AdvertisementMapper;
...
public class PromotionServiceImpl implements PromotionService {
    ...
    public void createAdvertisement(AdvertisementDTO dto) {
        ...
        if (dto == null) {
            log.warn("广告DTO为空");
            throw new BusinessException(BizErrorCode.PARAM_ERROR, "广告数据不能为空");
        }
        ...
        if (rows > 0) {
            ...
            throw new BusinessException("广告保存失败");
        }
    ...
    public void updateAdvertisement(Long id, AdvertisementDTO dto) {
        ...
        if (rows > 0) {
            ...
            throw new BusinessException("广告更新失败");
        }
    ...
    public void deleteAdvertisement(Long id) {
        ...
        if (rows > 0) {
            ...
            log.error("广告删除失败，影响行数为0: id={}, title={}", 
                id, advertisement.getTitle());
            throw new BusinessException("广告删除失败");
        }
    ...
    public void updateStatus(Long id, Integer status) {
        ...
        if (rows > 0) {
            ...
            throw new BusinessException("广告状态更新失败");
        }
    ...
    public void updateSortOrder(Long id, Integer sortOrder) {
        ...
        if (rows > 0) {
            ...
            throw new BusinessException("广告排序更新失败");
        }
     ...
     * @param position 广告位置
     * @return 有效的广告列表
     * @throws BusinessException 当位置参数无效时抛出
     */
    @Override
